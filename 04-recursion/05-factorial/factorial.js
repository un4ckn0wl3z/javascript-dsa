 ...
 * 
 * factorial(2) = 2 * factorial(1) --> 2 * 1 = return <2>
 *                                           /
 * factorial(3) = 3 * factorial(2) --> 3 * <2> = return <6>
 *                                             /
 * factorial(4) = 4 * factorial(3) --> 4 * <6> = return <24>
 *                                              /
 * factorial(5) = 5 * factorial(4) --> 5 * <24> = return 120
 */